...
# session = px.launch_app(port=6006) # FIX: Removed deprecated port parameter to prevent server hangs. Passed via PHOENIX_PORT=6006 env var instead.
...
def run_support_agent():
    ...
    #     }
    # }
    # FIX: The old "inputText" format is for Titan models. Amazon Nova requires the "messages" API format.
    body = {
            "messages": [
    ...
    # FIX: Updated response parsing logic to correctly extract text from the Nova model's response format.
